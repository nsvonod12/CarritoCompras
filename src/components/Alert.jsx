...
export default function Alert({openAlert, setOpenAlert}) {
  ...
  return (
    <Transition.Root show={openAlert} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={setOpenAlert}>
        <Transition.Child
          as={Fragment}
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-green-200 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start md:items-center">
